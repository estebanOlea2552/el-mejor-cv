...
const TEMPLATE_THEMES: Record<string, Theme[]> = {
  ...
  t02: [
    ...
    {
      key: 'theme02',
      themeName: 'light-salmon',
      colors: ['#5D2A42', '#FFDCCC'],
    },
    {
      key: 'theme03',
      themeName: 'concrete-blue',
      colors: ['#364156', '#C2CFD6'],
    },
    {
      key: 'theme04',
      themeName: 'light-lime-green',
      colors: ['#366360', '#C6F2C0'],
    },
    {
      key: 'theme05',
      themeName: 'pastel-purple',
      colors: ['#363663', '#BFAFF4'],
    },
    {
      key: 'theme06',
      themeName: 'grey-n-white',
  ...
  t03: [
    {
      key: 'theme01',
      themeName: 'dulce-de-leche',
      colors: ['#C17767', '#D3B99F'],
    },
    { key: 'theme02', themeName: 'ice-blue', colors: ['#335899', '#9ABFEA'] },
    {
      key: 'theme03',
      themeName: 'light-cherry',
      colors: ['#802635', '#FA9189'],
    },
    {
      key: 'theme04',
      themeName: 'warm-violet',
      colors: ['#BCC2EB', '#9C7CA5'],
    },
    {
      key: 'theme05',
      themeName: 'jungle-green',
      colors: ['#1D9172', '#004D3D'],
    },
  ...
  t04: [
    ...
    {
      key: 'theme04',
      themeName: 'strong-yellow',
      colors: ['#FFD000', '#FFF4E4'],
    },
  ...
  t05: [
    ...
    {
      key: 'theme02',
      themeName: 'green-clouds',
      colors: ['#0F4D4D', '#93e4d2'],
    },
    {
      key: 'theme03',
      themeName: 'blue-clouds',
      colors: ['#0F2A4D', '#abc5f6'],
    },
    {
      key: 'theme04',
      themeName: 'yellow-clouds',
      colors: ['#4D240F', '#f3ea92'],
    },
    {
      key: 'theme05',
      themeName: 'rainbow-clouds',
      colors: ['#aac4f5', '#ffc4bb'],
    },
    {
      key: 'theme06',
      themeName: 'grey-clouds',
      colors: ['#585858', '#c9c9c9'],
    },
  ],
};
...
@Component({
  ...
  template: `
    <div
      ...
      [ngClass]="{
        'buttons-container-mobile': isMobile,
        'buttons-container-desktop': !isMobile
      }"
    >
      <div
        class="theme-button"
        [ngClass]="{
          'theme-button-mobile': isMobile,
          'theme-button-desktop': !isMobile
        }"
      ...
      >
        <div
          class="color-primary"
          [ngStyle]="{ 'background-color': button.colors[0] }"
        ></div>
        <div
          class="color-secondary"
          [ngStyle]="{ 'background-color': button.colors[1] }"
        ></div>
      </div>
    </div>
  `,
...
export class ThemeSelectorComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.selectedTemplateSubscription = this.store
  ...
  selectTheme(theme: string): void {
    this.store.dispatch(selectTemplateTheme({ theme: theme }));
  }
