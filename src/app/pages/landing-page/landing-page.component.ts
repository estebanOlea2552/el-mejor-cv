...
export class LandingPageComponent implements OnInit, AfterViewInit {
  ...
  startWelcomeAnimation() {
    this.welcomeCurrentIndex =
      (this.welcomeCurrentIndex + 1) % this.welcomeImages.length;
    this.welcomeAnimationState = 'in';
  }
  startProfessionalsAnimation() {
    this.professionalsCurrentIndex =
      (this.professionalsCurrentIndex + 1) % this.professionalsImages.length;
